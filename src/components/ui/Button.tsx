  ...
  ({ className, variant = "primary", size = "md", ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "inline-flex items-center justify-center rounded-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 active:scale-95",
          variants[variant],
          sizes[size],
          className
        )}
